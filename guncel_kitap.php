<?php
    ...
    $sorgu = "UPDATE kitap SET eserAdi = '$eserAdi', eserBasimYili = '$eserBasimYili', eserISBN = '$eserISBN', eserAciklama = '$eserAciklama', yayineviNo = '$yayineviNo', yazarNo = '$yazarNo' WHERE eserKayitNo = $eserKayitNo";
...
echo("<table border=1 width=80%>");
    ...
    echo("<td><b>Eser Yayınevi</b></td>");
    echo("<td><b>Eser Yazar</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='guncelleme_kitap.php?eserKayitNo=".$satir["eserKayitNo"]."'>Güncelle</a></td>");
