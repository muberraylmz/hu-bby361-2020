...
<!-- KODLAR -->
<h1>Yayınevi Ekle</h1>
<form action="yayınevi_eklendi.php" method="post">
    Yayınevi Adi: <input type="text" name="yayineviAdi"><br><br>
    Yayınevi URL: <textarea name="yayineviURL" rows="2" cols="50"></textarea><br><br>
