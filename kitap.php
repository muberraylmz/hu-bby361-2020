...
$sorgu = mysqli_query($baglanti, "SELECT K.eserKayitNo, K.eserAdi, K.eserKayitTarihi, K.eserBasimYili, K.eserISBN, k.eserAciklama, Y.yayineviAdi, CONCAT (YZ.yazarAdi, ' ', YZ.yazarSoyadi) AS AdSoyad
