...
<form action="kitap_eklendi.php" method="post">
    Eser Adi: <input type="text" name="eserAdi"><br><br>
    Eser Basım Yili: <input type="text" name="eserBasimYili"><br><br>
    Eser ISBN: <input type="text" name="eserISBN"><br><br>
    Eser Açıklama: <input type="text" name="eserAciklama"><br><br>
    Eserin Yayinevi: <select name="yayinevi" id="yayinevi">
    ...
    Eserin Yazarı: <select name="yazar" id="yazar">
                <option value="Seçim Yapılmadı">Seçiniz</option>
