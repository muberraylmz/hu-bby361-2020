<?php
    ...
    $guncel_yayinevi = mysqli_real_escape_string($baglanti, $_GET["yayineviNo"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yayinevi WHERE yayineviNo = $guncel_yayinevi");
...
<form action="guncel_yayinevi.php" method="post">
    Yayınevi Adi: <input type="text" name="yayineviAdi" value="<?php echo $satir["yayineviAdi"] ;?>"><br><br>
