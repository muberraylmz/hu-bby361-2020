<?php
    ...
    $guncel_yazar = mysqli_real_escape_string($baglanti, $_GET["yazarNo"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yazar WHERE yazarNo = $guncel_yazar");
...
<form action="guncel_yazar.php" method="post">
    Yazar Adi: <input type="text" name="yazarAdi" value="<?php echo $satir["yazarAdi"] ;?>"><br><br>
    Yazar Soyadi: <input type="text" name="yazarSoyadi" value="<?php echo $satir["yazarSoyadi"] ;?>"><br><br>
