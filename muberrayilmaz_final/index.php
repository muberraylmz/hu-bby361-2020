...
<html lang="tr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Katalog Veri Tabanı</title>
...
<meta name="theme-color" content="#563d7c">
  ...
  <a class="navbar-brand" href="https://getbootstrap.com/docs/4.4/examples/navbar-static/#">Katalog Veri Tabanı</a>
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    ...
    <form class="form-inline mt-2 mt-md-0">
      <input class="form-control mr-sm-2" type="text" placeholder="Arama" aria-label="Arama">
 ...
 <html>
   <body>
    <h3>
     Katalog veri tabanıma hoş geldiniz. İlgili işlemlerinizi yapmak için lütfen yukarıdaki menüden yararlanınız.
    </h3>
   </body>
 </html>
