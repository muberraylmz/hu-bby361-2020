<?php
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM yazar ORDER BY yazarNo");
...
echo("<table border=1 width=80%>");
    echo("<tr>");
    echo("<td><b>Yazar Kayit No</b></td>");
    echo("<td><b>Yazar Adi</b></td>");
    echo("<td><b>Yazar Soyadi</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='guncel_yazar.php?yazarNo=".$satir["yazarNo"]."'>Güncelle</a></td>");
